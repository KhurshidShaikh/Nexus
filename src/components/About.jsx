  ...
  return (
    <div id="about" ref={sectionRef} className="relative min-h-screen overflow-hidden bg-white py-12 md:py-20">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
        ...
        <div className={`transform transition-all duration-1000 delay-200 text-center max-w-4xl mx-auto mb-12 md:mb-20 ${
          ...
          <div className="flex flex-col items-center mb-4 md:mb-6">
            ...
            <span className="text-sm md:text-xl text-blue-600 uppercase tracking-widest font-semibold mb-2 md:mb-3 bg-blue-50 px-4 md:px-6 py-2 rounded-full border border-blue-200">
              About Us
            </span>
            <div className="w-24 md:w-32 h-1 bg-gradient-to-r from-blue-500 via-indigo-500 to-blue-500 rounded-full shadow-lg"></div>
          </div>
          
          <h2 className="text-3xl md:text-5xl lg:text-7xl font-black text-gray-800 leading-tight mb-6 md:mb-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-start mb-12 md:mb-20">
          ...
          <div className="flex items-center justify-center">
            <div className="relative w-full max-w-lg">
              ...
              <div className={`relative bg-gray-50 border border-gray-200 rounded-3xl p-6 md:p-8 shadow-2xl transform transition-all duration-1000 ${
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                {innovations.map((item, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`group flex flex-col p-4 md:p-6 bg-white rounded-3xl border border-gray-200 shadow-2xl hover:shadow-3xl transition-all duration-700 transform min-h-[200px] md:min-h-[280px] ${
                    ...
                    >
                      <div className="flex items-start space-x-3 md:space-x-4 mb-3 md:mb-4">
                        <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                          <Icon className="w-5 h-5 md:w-6 md:h-6 text-white" />
                        </div>
                        <h4 className="text-lg md:text-xl font-bold text-gray-800 group-hover:text-blue-600 transition-colors duration-300 leading-tight">{item.title}</h4>
                      </div>
                      <div className="flex-1">
                        <p className="text-sm md:text-base text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">{item.description}</p>
                      </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
          ...
          <div className={`transform transition-all duration-1000 delay-1000 ${
            ...
            <div className="relative p-6 md:p-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl border border-blue-200 shadow-2xl">
              ...
              <p className="text-lg md:text-2xl font-medium text-gray-800 italic text-center pt-4 md:pt-6 px-4 md:px-8">
