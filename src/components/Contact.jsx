...
const Contact = () => {
  ...
  return (
    <div id="contact" ref={sectionRef} className="relative min-h-screen overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-green-50 py-20">
      {/* Background Elements */}
      <div className="absolute inset-0">
        ...
        <div className="absolute top-2/3 right-1/3 w-24 h-24 bg-green-400/10 rounded-full blur-xl animate-pulse delay-500"></div>
      </div>
