      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className={`mt-20 transform transition-all duration-1000 delay-800 ${
          ...
          <div className="bg-white rounded-3xl border border-gray-200 shadow-2xl overflow-hidden">
            <div className="aspect-[3/1] w-full bg-gradient-to-r from-blue-100 via-indigo-100 to-blue-100 flex items-center justify-center relative">
              <div className="text-center">
                <MapPin className="w-16 h-16 text-blue-500 mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-gray-800 mb-2">Our Location</h3>
                <p className="text-gray-600 max-w-md mx-auto">
                  508, Rosa Bella Towers, Waghbil, Ghodbunder Road, Thane West (Mumbai)-400815, Maharashtra, India
                </p>
                <a
                  href="https://maps.google.com/?q=508+Rosa+Bella+Towers+Waghbil+Ghodbunder+Road+Thane+West+Mumbai+400815"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-2 mt-4 px-6 py-3 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-all duration-300"
                >
